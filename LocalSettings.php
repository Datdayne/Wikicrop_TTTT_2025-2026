...
# --- CẤP QUYỀN TẠO TÀI KHOẢN (BẮT BUỘC CHO SSO) ---
# Cho phép khách vãng lai tự đăng ký (để Keycloak có thể tạo user mới)
$wgGroupPermissions['*']['createaccount'] = false;

# Cho phép hệ thống tự động tạo tài khoản khi đăng nhập qua Extension
